...
// import logoWhite from '../assets/img/log-white.svg';
      ...
      <div className="container mx-auto px-4 lg:px-0 ">
        ...
        <div className="flex flex-col items-center lg:flex-row min-h-[740px]">
          <div className="flex-1 flex flex-col justify-center items-start" >
            ...
            <p className="font-light text-grey mb-10 max-w-[597px] dark:text-white ">
         
              We specialize in small businesses. our goale is to eliminate
              bureaucracy, crating a modern relationship between your company
              and the accountant.{" "}
            </p>
            {/* <div className="flex flex-col gap-y-6 mb-8"></div> */}
            <div className="mb-8" >
